...
var configs = (function () {
    var instance;
    var Singleton = function (opt) {
        var options = opt || Singleton.defaultOptions;
    ...
    Singleton.defaultOptions = {
        general_help: "Below there's a list of commands that you can use.\nYou can use autofill by pressing the TAB key, autocompleting if there's only 1 possibility,\n or showing you a list of possibilities.",
        ...
        welcome: "Welcome to my website, i'm Francesco Pio Covino :)\nI'm a Computer Science studente\n I like parmigiana and learn new things.",
